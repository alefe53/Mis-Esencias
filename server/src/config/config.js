...
if (!config.supabase.URL || !config.supabase.SERVICE_KEY) {
  console.error("CRÍTICO: Las variables de Supabase no están definidas en .env");
...
if (config.jwt.SECRET === "secreto_inseguro_cambiar_en_produccion") {
  console.warn("ADVERTENCIA: JWT_SECRET está usando un valor por defecto inseguro.");
}