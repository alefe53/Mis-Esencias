...
import { getPublicUrl, broadcastRealtimeEvent } from "../utils/supabaseUtils.js";
...
const postMessage = async (authToken, content, parentId) => {
...
const error = new Error("No se pudo crear el mensaje en la base de datos o no se recibió una respuesta válida.");
error.statusCode = 500;
throw error;
}

await broadcastRealtimeEvent(
'global_chat_realtime', // El mismo nombre de canal que usa el frontend
'new_message',          // El mismo nombre de evento que escucha el frontend
{ id: rawNewMessage.id }  // El payload que espera el frontend
);
