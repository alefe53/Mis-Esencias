...
export const updatePost = (authToken, postId, title, content) => {
    return adminRepository.updatePostInDB(authToken, postId, title, content);
};

export const updateComment = (authToken, commentId, content) => {
    return adminRepository.updateCommentInDB(authToken, commentId, content);
};