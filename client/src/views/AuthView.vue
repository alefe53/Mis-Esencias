...
: 'Entrá si te da, sino anda payá.'
  ...
  <button class="google-button" @click="handleGoogleLogin" :disabled="isLoading">
    <svg version="1.1" xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" width="18px" height="18px" viewBox="0 0 48 48">
      <g>
...
errorMessage.value = error.message || "Error al procesar el login de Google.";
} finally {
isLoading.value = false;
}
}
