...
export const addCommentToPost = async (postId: number, content: string): Promise<PostComment> => {
...
export const castVoteOnPoll = async (postId: number, optionId: number): Promise<PollData> => {
